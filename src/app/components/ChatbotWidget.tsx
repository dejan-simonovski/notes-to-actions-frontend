...
export function ChatbotWidget() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end font-sans">
      {/* Chat Window */}
      <div
        className={`mb-4 w-96 h-[500px] bg-white border border-gray-150 rounded-2xl shadow-2xl flex flex-col overflow-hidden transition-all duration-300 ease-out origin-bottom-right ${
          isOpen
      ...
      >
        ...
        <div className="bg-indigo-600 text-white px-5 py-4 flex items-center justify-between shadow-sm">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="font-semibold text-sm leading-tight text-white m-0">Meeting Assistant</h3>
          ...
          {messages.map((msg) => (
            ...
            >
              ...
              <div>
                ...
                <span
                  className={`text-[10px] text-gray-400 mt-1 block px-1 ${
      ...
      <button
        onClick={toggleOpen}
        className="w-14 h-14 bg-indigo-600 hover:bg-indigo-700 text-white rounded-full flex items-center justify-center shadow-lg hover:shadow-xl active:scale-95 transition-all hover:rotate-3 cursor-pointer border border-indigo-500/20"
      >
