      ...
      <div className="border-b border-gray-200 bg-white px-4 sm:px-6 md:px-8 py-4 sm:py-6">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
              <h1 className="text-gray-900 mb-1 text-lg sm:text-xl md:text-2xl">{meeting.title}</h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
            <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden flex flex-col lg:max-h-[calc(100vh-200px)]">
              <div className="p-4 sm:p-6 border-b border-gray-200 flex-shrink-0">
                <h2 className="text-gray-900 text-base sm:text-lg font-semibold">Transcript</h2>
              </div>
            ...
            <div className="space-y-4 sm:space-y-6">
              <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-4 sm:p-6">
                <h3 className="text-gray-900 mb-3 sm:mb-4 font-semibold text-base sm:text-lg">Meeting Summary</h3>
              ...
              <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-4 sm:p-6">
                <h3 className="text-gray-900 mb-3 sm:mb-4 font-semibold text-base sm:text-lg">Key Decisions</h3>
                <ul className="space-y-2">
                  {meeting.decisions.map((decision, idx) => (
                    <li key={idx} className="flex items-start gap-3">
                      <CheckCircle className="text-green-600 flex-shrink-0 mt-0.5" size={16} />
                      <span className="text-gray-700 text-sm sm:text-base">{decision}</span>
                    </li>
                  ))}
                </ul>
              </div>
              ...
              <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-4 sm:p-6">
                <h3 className="text-gray-900 mb-3 sm:mb-4 font-semibold text-base sm:text-lg">Action Items</h3>
                  ...
                  {meeting.actionItems.map((item) => (
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="text-gray-900 mb-1.5 text-sm sm:text-base">{item.task}</div>
                      ...
                      <span
                        className={`px-2 py-0.5 sm:px-3 sm:py-1 rounded-full text-xs whitespace-nowrap flex-shrink-0 ${item.status === "Done"
              ...
              <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-4 sm:p-6">
                <h3 className="text-gray-900 mb-3 sm:mb-4 font-semibold text-base sm:text-lg">Key Topics</h3>
